...
import Menu, {
  ...
  MenuSubMenu,
  MenuItemGroup
} from "../../components/uielements/menu";
import Dropdown, {
  DropdownButtons,
  DropdownMenu,
  MenuItem,
...
import Datepicker, {
  ...
  DateMonthpicker,
  DateWeekpicker
} from "../../components/uielements/datePicker";
  ...
  constructor(props) {
    ...
    this.menu = (
      <DropdownMenu onClick={onClick}>
        <MenuItem>
          <a target="_blank" key="1" rel="noopener noreferrer">
            アイテム１
          </a>
        </MenuItem>
        <MenuItem>
          <a target="_blank" key="2" rel="noopener noreferrer">
            アイテム２
          </a>
        </MenuItem>
        <MenuItem>
          <a target="_blank" key="3" rel="noopener noreferrer">
            アイテム３
          </a>
        </MenuItem>
        ...
        <ComponentGuideWrapper className="isomorphicTodoComponent">
          ...
          <p>
            ...
            <ul className="isoGuideList">
              ...
              <li>
                <h4 className="isoGuideHeader c2">
                  アイコン付きボタン<Tooltip title="アイコン一覧を見る">
                    <a
                      href="https://ant.design/components/icon/#Directional-Icons"
                      target="_blank"
                    >
                      <Icon type="link" />
                    </a>
              ...
              <li>
                <h4 className="isoGuideHeader c2">
                  グループ化（複数のButtonをButtonGroupに入れることができる）
                </h4>
                <div className="sampleContainer">
                  <ButtonGroup>
                    <Button type="primary">
          ...
          <p>
            ...
            上記の例では、SelectOptionGroupコンポーネントを使用してオプションのカテゴリ名を表示しています。<br />
            <br />
            <br />
            Selectコンポーネントはいろいろなモードがあります。
            <br />
            Multipleモードを用いれば複数選択できるセレクトボックスを実装できます。
            <a href="https://codesandbox.io/s/kwl747n2qr" target="_blank">
              <Tooltip title="実装を見る">
                <Icon type="link" />
              </Tooltip>
            </a>
            ...
            <a href="https://codesandbox.io/s/v0qm75vo8y" target="_blank">
              <Tooltip title="実装を見る">
                <Icon type="link" />
              </Tooltip>
            </a>
            ...
            <a href="https://codesandbox.io/s/zkk2o39zq4" target="_blank">
              <Tooltip title="実装を見る">
                <Icon type="link" />
              </Tooltip>
            </a>
            ...
            <ul class="simpleListContainer">
              <li>
                複数のセレクトボックスを連動
                <a href="https://codesandbox.io/s/j4w1mp8x6w" target="_blank">
                  <Tooltip title="実装を見る">
                    <Icon type="link" />
                  </Tooltip>
                </a>
              ...
              <li>
                Ajax通信をして結果を入力補助に使用
                <a href="https://codesandbox.io/s/4xm27y0mpw" target="_blank">
                  <Tooltip title="実装を見る">
                    <Icon type="link" />
                  </Tooltip>
                </a>
              ...
              <li>
                メールアドレス用にドメインを補助入力
                <a href="https://codesandbox.io/s/9koom957w" target="_blank">
                  <Tooltip title="実装を見る">
                    <Icon type="link" />
                  </Tooltip>
                </a>
              ...
              <li>
                ...
                <a href="https://codesandbox.io/s/98mz3y7l1w" target="_blank">
                  <Tooltip title="実装を見る">
                    <Icon type="link" />
                  </Tooltip>
                </a>
          ...
          <p>
            ...
            <a href="https://codesandbox.io/s/43lp1my2o9" target="_blank">
              <Tooltip title="全選択・全解除の実装を見る。">
                <Icon type="link" />
              </Tooltip>
            </a>
            <div className="sampleContainer">
            ...
            下記の例では <code>['Apple', 'Pear', 'Orange'];</code>{" "}
            を受け取って表示しています。<br />
          ...
          <p>
            ...
            RadioGroupコンポーネントは別に定義した配列を受け取り、それをラジオボタンとして表示することができます。<br />
            <br />
            下記の例では <code>['Apple', 'Pear', 'Orange'];</code>{" "}
            を受け取って表示しています。<br />
          ...
          <p>
            ...
            modeは縦・横・インラインの三種類、themeはライト・ダークの二種類があります。<br />
            <br />
            横の場合：
            <div className="sampleContainer">
            ...
            <br />
            インラインモードは縦メニューの一種ですが、縦メニューを小さく仕舞えるのが特徴です。<Tooltip title="インラインメニューの実装を見る。">
              <a href="https://codesandbox.io/s/71n0o1m671" target="_blank">
                <Icon type="link" />
              </a>
            </Tooltip>
          </p>
          <p>
            ...
            <Tooltip title="実装を見る。">
              <a href="https://codesandbox.io/s/1r20q30l" target="_blank">
                <Icon type="link" />
              </a>
            </Tooltip>
          </p>
          <p>
            ...
            持つことができるステータス　<code>wait</code>,　<code>process</code>,　<code
            >
              finished
            </code>,　<code>error</code>　の例:
            <div className="sampleContainer">
            ...
            持つことができるステータスは<code>wait</code>,<code>process</code>,<code
            >
              finished
            </code>,<code>error</code>の4種類です。
            <div className="sampleContainer">
              <Steps>
                <Step
                  status="finish"
            ...
            <Tooltip title="実装を見る。">
              <a href="https://codesandbox.io/s/71rxl7rp11" target="_blank">
                <Icon type="link" />
              </a>
            </Tooltip>
            <div className="sampleContainer">
          ...
          <p>
            ...
            日付、週、月、範囲を選ぶコンポーネントがあり、 サイズを変更したり
            <a href="https://codesandbox.io/s/k9pnrmn9wv" target="_blank">
              <Tooltip title="実装を見る">
                <Icon type="link" />
              </Tooltip>
            </a>
            ・ 非活性にしたり
            <a href="https://codesandbox.io/s/2pm8zrz1np" target="_blank">
              <Tooltip title="実装を見る">
                <Icon type="link" />
              </Tooltip>
            </a>
            ...
            <ul class="simpleListContainer">
              ...
              <li>
                選択されそうな選択肢を用意しておく。（本日・今月など）<a
                  href="https://codesandbox.io/s/8n2v0yq662"
                  target="_blank"
                >
                  <Tooltip title="実装を見る">
                    <Icon type="link" />
              ...
              <li>
                日付表示のデザインを変更する。（祝日などの色を変えられそうです）<a
                  href="https://codesandbox.io/s/m33xv6521y"
                  target="_blank"
                >
                  <Tooltip title="実装を見る">
                    <Icon type="link" />
          ...
          <p>
            ...
            <div className="sampleContainer">
              <Textarea
                placeholder="入力値によって自動的にサイズが変わります。"
                autosize
              />
              <div style={{ margin: "24px 0" }} />
              <Textarea
                placeholder="行の数の最小・最大はautosizeプロパティに値を設定できます。"
            ...
            <a href="https://codesandbox.io/s/32vpkrpowm" target="_blank">
              <Tooltip title="その他のInputGroupのサンプルを見る。">
                <Icon type="link" />
              </Tooltip>
            </a>
            <div className="sampleContainer">
            ...
            <a href="https://codesandbox.io/s/r5qw1mlpjn" target="_blank">
              <Tooltip title="入力チェックを含むサンプルを見る">
                <Icon type="link" />
              </Tooltip>
            </a>
            <div className="sampleContainer">
              ...
              >
                <Input placeholder="Input a number" maxLength="25" />
              </Tooltip>
            </div>
            入力欄の前後にはアイコンを表示させることができます。
            <a href="https://codesandbox.io/s/wyjpoq687l" target="_blank">
              <Tooltip title="サンプルを見る">
                <Icon type="link" />
              </Tooltip>
            </a>
          </p>
          <p>
            ...
            FormItemでひとつひとつの入力要素(Input,
            Checkbox...等々)で囲い、それらをFormで包みます。<br />
            ...
            <a href="https://codesandbox.io/s/6x16n3rm3n" target="_blank">
              <Tooltip title="状態管理のサンプルを見る">
                <Icon type="link" />
              </Tooltip>
            </a>
            <div className="sampleContainer">
              <Form layout="inline">
                ...
                <FormItem validateStatus="success" help="英数字記号8文字以上">
              ...
              <Form>
                ...
                <FormItem validateStatus="error" help="英数字記号8文字以上">
                  <Input placeholder="パスワード" style={{ width: 200 }} />
                </FormItem>
                <FormItem>
                  <Button type="primary" htmlType="submit" disabled={false}>
            ...
            入力欄が増えるフォームの作例もあります。
            <a href="https://codesandbox.io/s/04pw0q3pqv" target="_blank">
              <Tooltip title="サンプルを見る。">
                <Icon type="link" />
              </Tooltip>
            </a>
