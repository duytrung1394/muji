...
const routes = [
  ...
  {
    path: "tasks/",
    component: asyncComponent(() => import("../Task/index"))
  },
  {
  ...
  {
    path: "tasks/new",
    component: asyncComponent(() => import("../Task/new"))
  },
  {
    path: "tasks/:id(\\d+)",
    component: asyncComponent(() => import("../Task/show"))
  },
  {
    path: "tasks/:id(\\d+)/edit",
    component: asyncComponent(() => import("../Task/edit"))
  },
  ...customRoutes
];
