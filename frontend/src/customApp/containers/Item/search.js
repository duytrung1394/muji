...
class Search extends Component {
  ...
  render() {
    const statusOptions = [
      {
        label: this.props.intl.formatMessage({ id: "item.form.option.empty" }),
        value: ""
      },
      {
    ...
    return (
      <div>
        <Button type="primary" onClick={this.showModal}>
          {this.props.intl.formatMessage({ id: "item.search.show" })}
        </Button>
        <Modal
          ...
          <Form>
            ...
            >
              <Input
                ...
                onChange={event =>
                  this.handleChange("item_name", event.target.value)
                }
              />
            </FormItem>
            <FormItem
            ...
            >
              <Input
                ...
                onChange={event =>
                  this.handleChange("item_code", event.target.value)
                }
              />
            </FormItem>
            <FormItem
