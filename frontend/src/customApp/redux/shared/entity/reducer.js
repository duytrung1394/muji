...
// POST
export const createRequest = (state, action) => state
  .set('creating', true)
  .set('created', false)
  .set('createError', false)
  .set('createErrors', {});

export const createSuccess = (state, action) => state
  .set('creating', false)
  .set('entity', action.payload.item)
  .set('created', true);

export const createFailure = (state, action) => state
  .set('creating', false)
  .set('createError', true)
  .set('createErrors', action.payload.response.data.errors);

export const createCleanup = (state, action) => state
  .set('creating', false)
  .set('created', false)
  .set('entity', {})
  .set('createError', false)
...
// PUT
export const updateRequest = (state, action) => state
  .set('updating', true)
  .set('updated', false)
  .set('updateError', false)
  .set('updateErrors', {});

export const updateSuccess = (state, action) => state
  .set('updating', false)
  .set('updated', true);

export const updateFailure = (state, action) => state
  .set('updating', false)
  .set('updateError', true)
  .set('updateErrors', action.payload.response.data.errors);

export const updateCleanup = (state, action) => state
  .set('updating', false)
  .set('updated', false)
  .set('entity', {})
  .set('updateError', false)
