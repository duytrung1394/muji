  ...
  return(
    <OrderWrapper>
      ...
      <OrderInfo>
        ...
        <ShoppingAddress>
          {
            orderItem && orderItem.store_name ? (
              <StoreName>{orderItem.store_name}</StoreName>
            ) : (
              <Link to={"#"}>{orderItem.order_address}</Link>
            )
          }
        </ShoppingAddress>
      </OrderInfo>
      ...
      <OrderButtonWrapper>
        <OrderButton>
          <Link to={"#"} style={orderItem.cancel_button_disabled ? {color: "rgba(0, 0, 0, 0.4)"} : null}>
            {orderItem.cancel_button}
            <Icon type="right" style={orderItem.cancel_button_disabled ? {color: "rgba(0, 0, 0, 0.09)"} : null}/>
          </Link>
        </OrderButton>
        <OrderButton>
          <Link to={"#"}>
