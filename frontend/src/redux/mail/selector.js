...
const allMailsSelector = state => state.get("allMails");
const filterAttrSelector = state => state.get("filterAttr");
const searchStringSelector = state => state.get("searchString");
