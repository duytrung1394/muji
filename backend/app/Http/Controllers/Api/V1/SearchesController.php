...
class SearchesController extends Controller
{
   ...
   /**
     ...
     * @return Response
     */
    public function show($searchCode)
    {
        return [
            'data' => $this->getMockdata($searchCode),
        ];
    }
     ...
     * @return Response
     */
    public function update(Request $request, $searchCode)
    {
        return [
            'data' => [],
        ];
    ...
    private function getMultiMockData($page = 1)
    {
        ...
        for ($i = 0; $i < 10; $i++) {
            $data[] = $this->getMockData('search_code' . ($i + $start ));
        }
