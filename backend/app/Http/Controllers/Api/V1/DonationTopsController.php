    ...
    private function getMultiMockData()
    {
        return [
            ...
            'article' => [
                ...
                世界で森林が減り、動物の住まいが追われていること。危機的な状況にあって苦しんでいる子どもたちがいること。ニュースでは流れなくなった被災地のこと。たくさんのことはできないかもしれないけれど、何かしたい。無印良品は、みなさんの気持ちを集めて届ける仕組みを考えました。
                募金券は、どなたでもお買い物のように10円または100円単位で寄付ができる仕組みです。みなさんにしていただいた寄付はすべて、無印良品がまとめて所定の寄付先団体に届けます。",
